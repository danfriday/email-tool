...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;">
    ...
    <tr>
        <td>
            <img src="{{FLYER_IMAGE_URL}}" 
                 alt="Praise Party 3.0 - Victory"
                 width="100%"
    ...
    <tr>
        <td style="padding:24px 20px;">
            ...
            <p style="margin:0 0 20px;line-height:1.7;font-size:16px;">
                Come and praise, thank, and worship our Maker with us!
            </p>

            <p style="margin:0 0 20px;line-height:1.7;font-size:16px;">
                <strong>Praise Party 3.0 Concert</strong> is here again, and this year's theme is
                <strong>VICTORY</strong>.
            </p>

            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:25px 0;">
                <tr>
                    <td style="padding:15px;background:#fafafa;border-left:4px solid #6a35ff;">
            ...
            <p style="margin:0 0 20px;line-height:1.7;font-size:16px;">
                You are specially invited to join us for an unforgettable evening of praise,
                thanksgiving, worship, and celebration.
            </p>

            <p style="margin:0 0 30px;line-height:1.7;font-size:16px;">
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" align="center" style="margin:0 auto 24px;width:auto;">
                <tr>
                    <td align="center" bgcolor="#6a35ff" style="border-radius:4px;">
                        <a href="https://rccglp20youths.com/register.php"
                           style="display:inline-block;padding:12px 22px;color:#ffffff;text-decoration:none;font-weight:bold;font-size:16px;border-radius:4px;">
                            Register Now
                        </a>
                    </td>
                </tr>
            ...
            <p style="margin:0 0 20px;line-height:1.7;font-size:16px;">
                Let's fill the house with praise and dance the Victory Dance together.
                Bring your family, friends, and anyone ready for a night of thanksgiving.
            </p>
            ...
            <p style="margin:0;font-size:16px;">
                Blessings,<br><br>
                <strong>Bukola Onaolapo</strong><br>
                Program Director<br>
                Praise Party 3.0
            </p>
...
export function getEmailTemplate(templateName: string = 'praise-party'): EmailTemplate {
  switch (templateName) {
    case 'praise-party':
      return PRAISE_PARTY_TEMPLATE;
    default:
      return PRAISE_PARTY_TEMPLATE;
  }
}
...
export function interpolateEmail(
  ...
  name: string,
  email: string,
    flyerImageUrl: string = '/api/flyer'
): EmailTemplate {
  return {
    subject: template.subject.replace(/\{\{NAME\}\}/gi, name).replace(/\{\{name\}\}/gi, name),
    html: template.html
